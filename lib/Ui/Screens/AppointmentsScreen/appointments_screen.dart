                ...
                if (state is GetUpComingAppointmentLoaded) {
                  if (state.isLoaded) {
                    ...
                    return getUpComingAppointmentsModel.appointments == null
                        ? const Center(
                      child: Text("There No Appointments"),
                    )
                        : ListView.builder(
                        itemCount: getUpComingAppointmentsModel
                            .appointments!.appointmentsDetails!.length,
                        itemBuilder: (context, index) {
                          return AppointmentCardWidget(
                            docterImage: getUpComingAppointmentsModel
                                ...
                                .docterImage
                                .toString(),
                            docterFirstname: getUpComingAppointmentsModel
                                .appointments!
                                .appointmentsDetails![index]
                                .firstname
                                .toString(),
                            docterSecondName: getUpComingAppointmentsModel
                                .appointments!
                                .appointmentsDetails![index]
                                .secondname
                                .toString(),
                            ...
                            tokenNumber: getUpComingAppointmentsModel
                                ...
                                .tokenNumber
                                .toString(),
                            clinicName: getUpComingAppointmentsModel
                                .appointments!
                                .appointmentsDetails![index]
                                .clincs!
                                .first
                            ...
                            bookinTime: getUpComingAppointmentsModel
                                ...
                                .tokenBookingTime
                                .toString(),
                            bookingDate: getUpComingAppointmentsModel
                                .appointments!
                                .appointmentsDetails![index]
                                .tokenBookingDate
                                .toString(),
                            ...
                            estimatedArrivalTime: getUpComingAppointmentsModel
                                ...
                                .estimateTime ==
                                null
                                ? getUpComingAppointmentsModel.appointments!
                                .appointmentsDetails![index].startingtime
                                .toString()
                                : getUpComingAppointmentsModel.appointments!
                                .appointmentsDetails![index].estimateTime
                                .toString(),
                            ...
                            liveToken: getUpComingAppointmentsModel
                                .appointments?.currentOngoingToken ??
                                '0'.toString(),
                          );
                        });
                  } else {
              ...
              builder: (context, state) {
                ...
                if (state is GetCompletedAppointmentLoaded) {
                  ...
                  return ListView.builder(
                      itemCount:
                          getCompletedAppointmentsModel.appointments!.length,
                      itemBuilder: (context, index) {
                        return Stack(
                          children: [
                            Column(
